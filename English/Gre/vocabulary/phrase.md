...
- hustle and bustle 热闹繁华

- growth prospects 增长前景
The company's growth prospect is very promising. 公司的增长前景非常有希望
- in prospect 期望中的
There are no developements in prospect.没有发展前途

- comparative literature（美国）《比较文学》季刊
He majored in comparative literature. 他的专业是比较文学
- comparative advantage比较优势
In international trade, countries specialize in producting goods and services in which they have a comparative advantage.在国际贸易中，各国专门生产他们具有的比较优势的商品和服务。
- comparative statics比较静态优势
In economics, comparative statics is the analysis of the changes in equilibrium that result from a change in one or more exogenous variables, while holding all other variables constant.在经济学中，比较静态分析方法是指在其他变量表示不变的情况下，分析均衡状态因一个或多个外生变量的改变而产生的变化。

- conservation area （英国自然环境或建筑物的）保护区
The local council has designated this forest as a conservation area to protect its unique wildlife.

- without exception 一律，无一例外的
Pain is in itself an evil, and, indeed without exception, the only evil.苦痛本身就是一项罪恶，而且实际上毫无例外地，是唯一的罪恶。
- an exception to ...的一个例外
There is always an exception to any rule. 任何规律总有例外。
- with the exception of除...之外
With the exception of Mike, everyone was at the party.除了迈克，每个人都参加了派对。
- make an exception破例
- above/beyond exception无可非议
- take exception to反对
He tooke exception to the unfair treatment of his team.

- solid state 固态的，固态元件[器件]的
Ice is water in solid state.冰是水的固体状态
- rock solid 非常牢固的
The foundation of the building is rock solid.这座建筑的基础非常坚固
...
The duration curve shows the relationship between the amount of electricity generated and the time of day.这个例子中的历时曲线显示了发电量与一天中时间之间的关系
- rating curve标定曲线，水位流量关系曲线，定额曲线，流量曲线
The rating curve shows the relationship between the water level and the discharge of a river.
- curve fitting【统】曲线求律法
- growth curve 生长曲线
- demand curve 需求曲线
...
- in command of 指挥着
- command economy计划经济
In a command economy, the government controls all aspects of production and distribution.在一种计划经济中，政府控制着生产和分配的所有方面。
- commanding officer指挥官
- command attention 引起注意
- command staff 司令部，指挥人员
...
The doctor noticed the patient has distention of jugular vein.医生注意到病人颈静脉扩张
- varicose vein静脉曲张
...
I decided to plead no contest because I didn't want to admit guilt but also didn't want to go to trial. 我决定认罚不认罪，因为我不想承认有罪，但也不想上法庭。
- 
