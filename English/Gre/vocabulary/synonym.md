...
***
- 不停地 adj. incessant
- ceaseless | continual | continuous | nonstop | perpetual | unremitting
***
- 勇敢的，无畏的 adj. courageous
- bold | brave | dauntless | doughty | fearless | gallant
***
- （使）成熟 v.  ripen
- mature | grow up
***
- 动量，动力，冲力，势头 n. momentum
- boost | impetus | impulse | motivation | spur | stimulus
***
- 苍白的，无血色的，憔悴的 adj. wan
- ashen | cadaverous | pallid | pasty | pale
***
- instruction n. 教授；知道；指令；用法说明；[计]指令
- behest | dictate | direction | directive | imperative | command
***
- extravagant adj. 奢侈的；铺张浪费的；过于昂贵的；（言行）放肆的
- wasteful | prodigal | profligate | spendthrift | luxurious
***
- flexible adj. 灵活的；易弯曲的
- adaptable | adjustable | elastic | pliable
***
...
***
- luxury n./adj 奢侈的
- n. superfluity | extravagance
---
- barren adj. 贫瘠的；不育的；无效果的
- adj. impoverished | infertile | unfertile | unproductive
***
- numeric adj.数字的
- n. digit | figure | numeral | number
- adj. digital
---
- withhold v. 不给；停止；隐瞒；克制
- v. restrain | suppress | repress | hold back | keep back
---
- controversial adj. 引起争议的，有争议的
- adj. argumentative | contentious | disputatious
---
- emit v. 发出，散发
- v. emanate | give out | send out
---
- pivot n. 枢纽；中心点；核心 v. 在枢轴上旋转
- n.  core | heart | kernel | nub | nucleus | pith
- v. turn | revolve | rotate | spin | swing | twirl
---
...
---
- 命令
- v. dictate | command | order
- n. dictate | behest | command |injunction | instruction | order

- 命令，指挥
- n. command | behest | dictate | direction | directive | edict | imperative
- v. command | boss | enjoin | instruct | order
---

- 未经证实的
- adj. unsubstantiated | unverified | unsupported | unconfirmed | unproven
***

- 推 v
- hustle | push | shove | nudge | elbow
- 忙碌 n.
- hustle | bustle
***

- 预期，前景
- n. prospect | outlook | vista | expectation | anticipation | possibility | chance
- 勘察，勘探
- v. prospect | probe | explore | search | survey
***

- 保护 n.
- conservation | conservancy | preservation
***
...
- 固体，实心的 adj
- solid | firm | hard | credible | dependable | reliable
***

- 喝彩，称赞
- v. acclaim | applaud | cheer | hail | praise
- n. acclaim | applause | credit
***

- 相互联系 v.
- interrelate | interplay | interact | correlate
***

- 曲线
- n. curve | arc | arch | bend
- 弯曲
- v curve | arch | bend | bow | crook
***

- 祖辈的，先行的
- adj. antecedent | previous | former | preceding | prior
- n. antecedent | forebear | ancestor
***

- 召开，集合 v.
- convene | assemble | muster
***

- 赞助，资助，以高人一等的态度 v.
- patronize | sponsor | condescned | talk down
***

- 静脉；纹理；矿脉；矿层；风格；方式 n. vein
- manner | mode | style | streak | tripe | stratum
***
